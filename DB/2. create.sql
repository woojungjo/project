...
CREATE TABLE CRAWLING_BOARD(
    POST_NO NUMBER NOT NULL CONSTRAINT CRAWLIING_BOARD_POST_NO_PK PRIMARY KEY,
    MEMBER_ID  NUMBER NOT NULL,
...
CREATE TABLE CRAWLING_BOARD_BOOKMARK(
    BOOKMARK_NO NUMBER CONSTRAINT CRAWLING_BOARD_BOOKMARK_BOOKMARK_NO_PK 
    PRIMARY KEY,
...
CREATE TABLE CRAWLING_BOARD_ACT_NOT(
    NOT_NO NUMBER CONSTRAINT CRAWLING_BOARD_ACT_NOT_NOT_NO_PK PRIMARY KEY,
    MEMBER_ID NUMBER NOT NULL,
    POST_NO NUMBER,
    NOT_TARGET_MEMBER_ID NUMBER NOT NULL,
    NOT_CONTENT VARCHAR2(150) NOT NULL,
...
CREATE TABLE CRAWLING_BOARD_KEYWORD_NOT(
    NOT_NO NUMBER CONSTRAINT CRAWLING_BOARD_KEYWORD_NOT_NOT_NO_PK PRIMARY KEY NOT NULL,
    NOT_CONTENT VARCHAR2(150) NOT NULL,
    NOT_DT TIMESTAMP NOT NULL,
    NOT_READ_DT TIMESTAMP,
    POST_NO NUMBER ,
