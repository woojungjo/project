<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <head>
        ...
        <link rel="stylesheet" href="/resources/css/mypageEdit/change_password.css">
                    ...
                    <div id="mypage_article">
                        ...
                        <div class="mypage_article_content"> <!-- 탭 내용 -->
                            ...
                            <div class="table_wrap">
                                ...
                                <div class="article">
                                    <h3 class="input_title"><label for="password">기존 비밀번호</label></h3>
                                    <input type="password" id="password" placeholder="현재 비밀번호를 입력하세요" class="input"
                                        maxlength="16">
                                </div>

                                <div class="article">
                                    <h3 class="input_title"><label for="password">변경 비밀번호</label></h3>
                                    <input type="password" id="password" placeholder="새 비밀번호를 입력하세요" class="input"
                                        maxlength="16">
                                </div>

                                <div class="article">
                                    <h3 class="input_title"><label for="password">변경 비밀번호 확인</label></h3>
