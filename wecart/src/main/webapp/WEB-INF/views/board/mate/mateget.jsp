...
<div id="mate_board_info">
    <div class="mate_board_recruiting">
        ...
        <script>console.log($('.mate_board_recruiting_option option:selected').text());</script>
    ...
    </div><!--mate_board_writer_and_bookMark-->
...
<!-- MateBoard -->
    <div class="map_wrap">
        <div id="map" style="width:70%;height:80%;overflow:hidden; position: absolute;
  top: 50%;left: 50%;
   transform: translate(-50%, -50%);"></div>
    
        <div id="menu_wrap" class="bg_white" style="height:10%; overflow:hidden; position:absolute;top: 0px;
  left: 150px; z-index: 1;">
            <div class="option">
                <div>	
                	<form>
                        키워드 <input type="text" value="${__MateBoard__.meeting_area}" id="keyword" style="width:50%;height:100%;">
...
<div id="mate_board_info_below">
    ...
    </div><!--mate_board_modify_and_delete-->
