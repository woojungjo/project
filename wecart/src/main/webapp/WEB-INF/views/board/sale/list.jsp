        ...
        <main>
            ...
            <article id="board">
                <ul>
                    ...
                    <c:forEach items="${list}" var="saleBoardVO">
                        <li class="board_list">
                            <div class="board_grid">
                                <div class="board_head">
                                    <div>${saleBoardVO.member_id}</span></div>
                                    <fmt:formatDate value="${saleBoardVO.write_dt}" pattern="yyyyMMddHHmmss" var="write_dt" />
                                    <fmt:formatDate value="${saleBoardVO.write_dt}" pattern="yyyy-MM-dd" var="formatDate" />
                                    ...
                                    <div><span class="fas fa-heart"/>&nbsp;${saleBoardVO.like_count}</div>
                                    <div><span class="fas fa-heart-crack"/>&nbsp;${saleBoardVO.hate_count}</div>
                                </div>
                                    <div class="board_title"><a href="/board/sale/read/${saleBoardVO.post_no}">${saleBoardVO.title}</a></div>
                                <div class="board_tail">
                                    <div><span class="fas fa-eye" />&nbsp;${saleBoardVO.views}</div>
                                    <div><span class="fas fa-comment-dots" />&nbsp;${saleBoardVO.comment_count}</div>
                                </div>
                            </div>
                        </li>
                    </c:forEach>
            ...
            <div id="sticky">
                <form action="/board/sale/list" method="GET">
                ...
                <div id="move_page">
                    <c:choose>
                        <c:when test="${pageMaker.prev}">
                            ...
                            href="/board/sale/list${pageMaker.cri.pagingUri}">
                    ...
                    <c:forEach var="pageNum" begin="${pageMaker.startPage}" end="${pageMaker.endPage}">
                            <div class="${currPage eq pageNum ? 'currPage' : ''}">
                                ...
                                href="/board/sale/list${pageMaker.cri.pagingUri}">${pageNum}</a>
                            </div>
                    </c:forEach>
                    <c:choose>
