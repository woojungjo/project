    ...
    for ( var i=0; i<places.length; i++ ) {
        ...
        (function(marker, placetitle) {
		    ...
		    return function() {
		        ...
		        $("#materegister_smeeting_area").val(placetitle);
		        alert('미팅장소로 '+placetitle+'이 설정되었습니다.');
		   		 }
			})(placePosition));
			//여기까지
...
function addMarker(position, idx, placetitle) {
...
// 인포윈도우에 장소명을 표시합니다
function displayInfowindow(marker, placetitle) {
    var content = '<div style="padding:5px;z-index:1;">' + placetitle + '</div>';
